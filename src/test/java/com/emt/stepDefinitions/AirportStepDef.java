...
import com.emt.pages.AirportCabPage;
import com.emt.pages.HomePage;
import com.emt.utils.DriverSetup;
import com.emt.utils.ExcelUtils;
import com.emt.utils.ExcelWrite;
...
public class AirportStepDef {
	...
	public void load_test_data(String testCaseId) throws IOException {
		...
		airport = new AirportCabPage(driver);
